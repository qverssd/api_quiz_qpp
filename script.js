document.addEventListener('DOMContentLoaded', () => {
    ...
    const highScoreDisplay = document.getElementById('maxScore');
    const gameSetupDiv = document.getElementById('setup');
    ...
    let score = 0;
    let questionIndex = 0;
    let maxScore = parseInt(localStorage.getItem('HighScoreTrivia')) || 0; 
    ...
    function updateHighScore() {
        if (score > maxScore) {
           maxScore = score;
            localStorage.setItem('HighScoreTrivia', maxScore.toString());
            updateHighScoreDisplay();
        }
    }
